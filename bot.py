...
INFO_TEXT = (
    "📌 <b>Информация о Марии:</b>\n\n"
    "Недвижимость — это моя профессия, мой интерес и пространство, в котором я умею видеть больше, чем просто стены и квадратные метры.

Я работаю в сфере недвижимости более 12 лет, помогаю покупать, продавать и инвестировать. Знаю, как устроены семейные сделки, понимаю специфику элитного сегмента и умею искать решения в ситуациях, где стандартные сценарии не работают.

Моя география — Санкт-Петербург, регионы России и зарубежные направления.

Я работаю с теми, кто ценит время, комфорт, качество и хочет принимать решения осознанно. С теми, кому важно не просто найти объект, а понять, насколько он соответствует их целям, образу жизни и финансовым планам.

Я могу помочь с покупкой семейной квартиры, продажей дорогой недвижимости, переездом, ипотекой, сложными юридическими обстоятельствами и подбором инвестиционных проектов.

Отдельное направление моей работы — страхование. Дом, квартира, автомобиль, здоровье, ипотека — помогаю подобрать страховые решения под конкретные задачи.

Я верю, что хороший специалист — это не тот, кто просто закрывает сделку. Это человек, который умеет слышать, анализировать, предупреждать о рисках и быть рядом, когда особенно важно принять правильное решение.

Я — Мария. И я знаю, как искать возможности в недвижимости."
)
